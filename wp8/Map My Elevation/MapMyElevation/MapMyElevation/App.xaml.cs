...
namespace MapMyElevation
{
    public partial class App : Application
    {
        ...
        public static List<ChartData> listChartData { get; set; }
        public static List<ChartData> tempChartData { get; set; }
        public static Geocoordinate LastCoordinate { get; set; }
