...
namespace BeerTrends.Pages
{
    public partial class Scan : PhoneApplicationPage
    {
        ...
        protected override void OnNavigatedTo(System.Windows.Navigation.NavigationEventArgs e)
        {
            ...
            viewfinderCanvas.Tap += focus_Tapped;
        ...
        void _bcReader_ResultFound(Result obj)
        {
            ...
            if (!obj.Text.Equals(tbBarcodeData.Text) && !obj.Text.Equals("000"))
            {
                VibrateController.Default.Start(TimeSpan.FromMilliseconds(100));
                tbBarcodeType.Text = obj.BarcodeFormat.ToString();
                tbBarcodeData.Text = obj.Text;

                // found a bar code, go to beer details:
                NavigationService.Navigate(new Uri("/Pages/Beer/Details.xaml?UPC=" + obj.Text, UriKind.Relative));
            }
        }
